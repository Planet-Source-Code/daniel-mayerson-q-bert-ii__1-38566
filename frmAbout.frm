...
Private Sub Form_Load()
    ...
    lblTitle = "Q-Bert II"
    lblDescription = "A game based on Q-Bert. The hero goes hopping around on cubes, and a baddie tries to catch him. Q-Bert must jump on the transporter to clear the level." & vbNewLine & "Made with Visual Basic 6.0"
End Sub
