...
Option Explicit
'This is Q-Bert II. A total improvement to
'the original Q-Bert. This Q-Bert has walls,
'doors, guns, more and more flexible baddies
'lot's more levels, a level editor, and more.
'See the Readme file for a good explaination
'of how the code works
'You might notice some weird things, like
'sometimes I call Errhandlerr for errors and
'sometimes I don't. The reason is that
'for beginning Q-Bert II I used the files
'from the original Q-Bert. This is not
'something I will do with Q-Bert III
'(see Plans text file for more info)
'Sorry for the not-so-good Pictures and sounds
